        ...
        <div className="row">
          <div className="col-md-8">
            ...
            <div className=" mb-3">
              <div className="row no-gutters">
                <div className="col-md-4">
                  <img src="https://images.unsplash.com/photo-1498837167922-ddd27525d352?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MjB8fGZvb2R8ZW58MHx8MHx8&auto=format&fit=crop&w=600&q=60" className="card-img abcde" alt="..." />
                </div>
                <div className="col-md-8">
            ...
            <div className=" mb-3">
              <div className="row no-gutters">
                <div className="col-md-4">
                  <img src="https://images.unsplash.com/photo-1493770348161-369560ae357d?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTd8fGZvb2R8ZW58MHx8MHx8&auto=format&fit=crop&w=600&q=60" class="card-img abcde" alt="..." />
                </div>
                <div className="col-md-8">
                  <div className="card-body">
            ...
            <div className=" mb-3">
              <div className="row no-gutters">
                <div className="col-md-4">
                  <img src="https://plus.unsplash.com/premium_photo-1670006163348-b8eb307a80a3?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTN8fGZvb2R8ZW58MHx8MHx8&auto=format&fit=crop&w=600&q=60" className="card-img abcde" alt="..." />
                </div>
                <div className="col-md-8">
                  <div className="card-body">
                    <h5 className="card-title">Card title</h5>
          ...
          <div className="col-md-4 ">
            ...
            <div className="div">
              <div className="">
                <img src="https://static.toiimg.com/thumb/96516944.cms?width=680&height=512&imgsize=271458" className="card-img abcde" alt="..." />
                <h4>Indian cuisine among the best in the world, 5th in global ranking</h4>
